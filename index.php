...
<body>
    ...
    <section class="body-sign">
        <div class="center-sign">
                ...
                <div class="panel-body">
                    ...
                    if(isset($_GET["type"])){
                        ...
                        if($type=="invalid_password"){
                            ...
                            echo '<span style="color:red">The username you entered does not exist. Please try again!</span>';
                        }
            ...
            <p class="text-center text-muted mt-md mb-md">&copy; Copyright 2019. All rights reserved. Made with <span style="color:red;" class="glyphicon glyphicon-heart"></span> in NUST, Pakistan.</p>
        </div>
    </section>
    <!-- end: page -->
